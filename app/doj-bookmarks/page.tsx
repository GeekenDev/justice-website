...
export default function DOJBookmarksPage() {
  const [results, setResults] = useState<DOJBookmark[]>([]);
  ...
  useEffect(() => {
    ...
    async function loadBookmarks() {
      ...
      setError(null);
      try {
        const response = await fetch("/api/doj-search/bookmarks?limit=500", {
  ...
  return (
    <main className="app-shell">
      ...
      <section className="hero">
        ...
        <h1>My DOJ Bookmarks</h1>
        <p className="subtitle">Saved DOJ search results for quick access.</p>
      </section>
      ...
      <section className="panel">
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              {results.map((result) => {
                const pdfUrl = result.original_link ?? result.result_url;
                return (
